...
void setupPS2(){
  ...
  if (rumble)
    ...
    Serial.println("No PS2 controller found, check wiring, see readme.txt to enable debug. visit www.billporter.info for troubleshooting tips");
...
void loopPS2() {
  ...
  if(type == 2){ //Guitar Hero Controller
    ...
    stickLeftY = mapStick(PSS_LY); //Left stick, Y axis. Other options: LX, RY, RX  
